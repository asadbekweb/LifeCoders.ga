...
ВАЖНО!!!
Ставим только 1 ⭐️ так в бот с хорошим рейтингом будут приходить постоянно новые люди, и будет больше новых заданий!
По ссылке ⬇️⬇️⬇️⬇️⬇️
 https://telegram.me/storebot?start=denga_vsem_bot
       ''','markup':messages.start['markup']})

    if text == '📢 ПИАР':
     return send_message(message,{'text':'''
Здесь пока не чего нет
...
🔥 Минимальный вывод составляет 20 руб 🔥
...
👨‍✈️ ПРАВИЛА использования бота "Пиар каналов Бот ☑"
...
Поддержка: @payjoinsupport
Если бан:  @payjoinsupportbot
       ''','markup':messages.start['markup']})
